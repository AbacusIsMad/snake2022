...
class TestSettings(unittest.TestCase): 
    ...
    def test_initialisation(self): 
        ...
        self.assertEqual(settings.width, 60, "Width setting not initialised correctly")
        self.assertEqual(settings.height, 60, "Height setting not initialised correctly")
...
' The following tests were made redundant due to evolving dependencies in the other classes.
'
...
#     def test_initialisation(self):
#         settings = Settings()
#         straw = Strawberry(settings, parent=None)
...
#         self.assertEqual(straw.position, [15, 10], "Position was not set correctly for the food item")
    ...
    #     settings = Settings()
    #     snake = Snake()
    #     straw = Strawberry(settings, game=None)
